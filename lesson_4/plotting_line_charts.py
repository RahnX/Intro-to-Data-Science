...
def lineplot_compare(hr_by_team_year_sf_la_csv):
	...
	hr_by_team_year = pandas.read_csv(hr_by_team_year_sf_la_csv)

	return ggplot(hr_by_team_year, aes("yearID", "HR", color="teamID")) + geom_point() + geom_line() + ggtitle('HRs by Year') + xlab("Year") + ylab('Home Run')
